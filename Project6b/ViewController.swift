...
//            view.addConstraints( NSLayoutConstraint.constraints(withVisualF,
//                ormat: "H:|[\(label)]|", options: [], metrics: nil, views:
//                viewsDictionary))
//        }
//
//        view.addConstraints( NSLayoutConstraint.constraints(withVisualF,
//            ormat: "V:|[label1]-[label2]-[label3]-[label4]-[label5]",
//            options: [], metrics: nil, views: viewsDictionary))
//        let metrics = ["labelHeight": 88]
//
//        view.addConstraints( NSLayoutConstraint.constraints(withVisualF
//            ormat: "V:|[label1(labelHeight)]-[label2(labelHeight)]-
...
//            views: viewsDictionary))
        ...
        for label in [label1, label2, label3, label4, label5] {
            ...
            if let previous = previous {
                ...
                label.topAnchor.constraint(equalTo:
                    view.safeAreaLayoutGuide.topAnchor, constant: 0).isActive =
                true
            }
    }
}
